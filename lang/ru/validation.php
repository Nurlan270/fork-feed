...
return [
    ...
    'custom' => [
        'images.*' => [
            'max' => 'Размер изображений не должен превышать 15 МБ',
        ],
        'name'     => [
            'regex' => 'Допускаются только буквы и пробелы',
        ],
        'username' => [
            'regex' => 'Никнейм не может содержать пробелы или специальные символы, кроме: ., -, _',
        ],
        'email'    => [
        ...
        'login'    => [
            'regex' => 'Email / Никнейм не может содержать пробелы.',
        ],
        'captcha'  => [
            'captcha' => 'Пожалуйста, введите правильный код с картинки.',
        ],
    ],
